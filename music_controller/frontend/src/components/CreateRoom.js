...
export default class CreateRoomPage extends Component{
        ...
        return (
            <Grid container spacing={1}>
                <Grid item xs={12} align = "center">
                    <Button color="secondary" onClick={this.handleRoomButtonPress} variant="contained"> Create Room</Button>
                </Grid>
                <Grid item xs={12} align = "center">
    ...
    renderUpdateButtons() {
        return (
            <Grid item xs={12} align = "center">
                <Button color="secondary" onClick={this.handleUpdateButtonPressed} variant="contained"> Update Room</Button>
            </Grid>
        );
    }
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={12} align = "center">
                        <FormControl component = "fieldset" >
                            ...
                            <RadioGroup row defaultValue={this.props.guest_can_pause.toString()} onClick = {this.handleGuestCanPauseChange}>
                    ...
                    <Grid item sm={12} align = "center">
                        <FormControl>
                            <TextField required={true} onChange={this.handleVotesChange} type={"number"} defaultValue={this.state.votes_to_skip} inputProps={{min: 1, style: {textAlign: "center"}}} />
                            <FormHelperText>
                                <div >
